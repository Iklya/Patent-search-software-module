<template>
    ...
    <b>Переключатель режима поиска</b>
    ...
    function parseDateRange(value){
        ...
        if(parts.length !== 2){
        throw new Error("Некорректный ввод диапазона дат")
        }
        ...
        throw new Error("Некорректный формат даты: " + from)
        }

        result.from = convertDate(from)
        ...
        throw new Error("Некорректный формат даты: " + to)
        }

        result.to = convertDate(to)
        ...
        if(!dateRegex.test(v)){
            throw new Error("Некорректный формат даты: " + v)
        }
